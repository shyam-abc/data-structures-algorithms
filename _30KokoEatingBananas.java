...
public class _30KokoEatingBananas {
    ...
    private boolean checkIfPossibleToEatBananas(int[] piles, int speed, int h) {
        long timeTaken = 0;
        for (int pile : piles) {
